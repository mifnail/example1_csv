...
#Добавление
def insert(fio,age,tel,grp,pol,email,kurs):
    global csv_file
    try:
...
def save(file_name):
        with open(file_name,'w',encoding='utf-8',newline='') as file:
            columns =['ном',"фио","возраст","телефон","группа",'пол','почта','курс']
...
def show_rows():
    if len(csv_file) == 0:
        ...
        print('{:<5}{:<25}{:<8}{:<12}{:<15}'.format(
            'ном', 'фио', 'возраст', 'телефон', 'группа','пол','почта','курс'
        ))
        for el in csv_file:
            print('{:<5}{:<25}{:<8}{:<12}{:<15}{:<15}{:<15}{:<15}'.format(el["ном"],
                el["фио"],
                el["возраст"],
                el["телефон"],
                el['группа'],
